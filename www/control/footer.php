...
<script>
    var test = new Date(<?php echo $user_tie_from_y;?>, <?php echo $user_tie_from_m;?>-1, <?php echo $user_tie_from_d;?>)
    var test1 = new Date(<?php echo $user_tie_to_y;?>, <?php echo $user_tie_to_m;?>-1, <?php echo $user_tie_to_d;?>)


    $(function() {
        $( "#from" ).datepicker({
            numberOfMonths: 1,
            minDate: new Date(<?php echo $user_tie_from_y;?>, <?php echo $user_tie_from_m;?>-1, <?php echo $user_tie_from_d;?>),
            maxDate: new Date(<?php echo $user_tie_to_y;?>, <?php echo $user_tie_to_m;?>-1, <?php echo $user_tie_to_d;?>)
